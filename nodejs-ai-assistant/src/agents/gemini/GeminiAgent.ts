import { GoogleGenerativeAI, HarmBlockThreshold, HarmCategory, type ChatSession } from "@google/generative-ai";
...
export class GeminiAgent implements AIAgent {
  ...
  private conversationHistory: { role: "user" | "model"; parts: string }[] = [];
...
- **Web Search**: You can reference web information and provide up-to-date content.
- **Current Date**: Today's date is ${currentDate}. Please use this for any time-sensitive queries.

**Crucial Instructions:**
1. Provide accurate, current, and helpful written content.
2. When the user asks for current information, news, or facts, ensure your response is based on the most recent data available.
3. Synthesize information to provide comprehensive and accurate answers.
4. Cite sources when referencing specific information or URLs.
...
Your goal is to provide accurate, current, and helpful written content that assists the user in their writing tasks.`;
  };
